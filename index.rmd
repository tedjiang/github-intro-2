...
author: Alexa Fredston-Hermann, PhD Student, Bren School, fredstonhermann@ucsb.edu <br> Elise Wall, Associate Specialist, IEE, ekwall@ucsb.edu <br>
...
**Version control** Track all of your changes clearly, without breeding files or losing old versions. Used for many programming languages.

## Why learn and use GitHub? 

**Version control** Track all of your changes clearly, without breeding files or losing old versions. Used for many programming languages.

Helps multiple people can work on code together, but is also a fantastic organizational tool for individuals.
GitHub allows you to back up code, easily switch between computers, undo mistakes, 'comment' on changes, and much more. 

## What is GitHub?  
Similar to Dropbox, certain folders on your local computer will be 'watched', with any changes able to be synced online.

## What is GitHub?  
Similar to Dropbox, certain folders on your local computer will be 'watched', with any changes able to be synced online.

You have more control about what is synced, and how often. You can store, share, track changes and collaboratively edit many filetypes (including this presentation!) using any application.
...
It is possible to revert back to any previous version, and who is responsible for line-by-line changes.

Other great features too! (Issues, a to-do list you can share and assign tasks) 
...
GitHub is so great for creating and sharing code, lots of things you rely on already use it: 
...
There are lots of ways you'd get into GitHub... group project, new job, want to contribute to/use someone's neat idea.
...
First, it'd be nice if the files were on your computer.
...
Now that you have a local copy of this code, you have some ideas. When you're at a good stopping point and want to save your progress, you 'commit' the code with a message describing the changes. 

Commit = the GitHub version of 'I did a thing!'
...Like 'save', but you also get to add a comment.

## GitHub Workflow and Vocabulary

* **commit**: message associated with your changes ([best practices](http://r-pkgs.had.co.nz/git.html#commit-best-practices))

![xkcd](fig/git_commit.png)
...
But wait! What if, in the meantime, someone else changed the original (bug fixes, for example)? To download new changes to the code from others, you 'pull' from GitHub. **This is also how you can switch computers and easily work on the same code.** 
...
After committing your changes and pulling the repository again, you're ready to 'upload' your version of the code to GitHub. To do this, you 'push' the code. 
...
What if you want to try something crazy, but stay organized?
...
* Clone it, then push and pull directly from the original ('master') - suitable for small group collaborations. Create 'branches' for big ideas.
